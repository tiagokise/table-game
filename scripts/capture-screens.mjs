...
console.log('1/5 — Seletor de assuntos');
await page.goto(BASE, { waitUntil: 'networkidle' });
await page.waitForSelector('.subject-grid');
await page.waitForTimeout(500);
await shot('01-seletor-assuntos');

console.log('2/5 — Modo perguntas personalizadas (uploader)');
...
console.log('3/5 — Tabuleiro (após escolher assunto Geografia)');
...
console.log('4/5 — Tela de ajuda (Como Jogar)');
...
console.log('5/5 — Quiz overlay com pergunta');
